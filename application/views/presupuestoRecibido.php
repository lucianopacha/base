...
<html lang="en">
  ...
  <body>
    ...
    <!-- Confirmación -->
     <section id="Contacto"> 
      <div class="container site-section site-block-3 bg-light">

        <div class="row">
          <div class="col-12 text-center">
            <span class="sub-title">Presupuesto</span>
            <h2 class="font-weight-bold text-black mb-5">Hemos recibido solicitud de presupuesto, se lo enviaremos a la brevedad.</h2>
          </div>
        </div>
      </div>
    </section>
